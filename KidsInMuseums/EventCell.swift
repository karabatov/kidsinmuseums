...
public class EventCell: ASCellNode {
    ...
    func attachmentImageForAge(from fromAge: Int, to toAge: Int) -> UIImage {
        ...
        switch (toAge) {
        case 0, 5...20, 30, 40, 50, 60, 70, 80, 90, 100: yearStr = NSLocalizedString("years", comment: "0, 5-19, x0")
        case 1, 21, 31, 41, 51, 61, 71, 81, 91, 101: yearStr = NSLocalizedString("year", comment: "x1 (except 11)")
        case 2...4, 22...24, 32...34, 42...44, 52...54, 62...64, 72...74, 82...84, 92...94: yearStr = NSLocalizedString("years", comment: "x2, x3, x4 except 12...14")
        default: yearStr = NSLocalizedString("years", comment: "x5...x9 except 15...19")
        }
